...
class Library(object):
    ...
    def niRFSG_GetDeembeddingSparameters(self, vi, sparameters):  # noqa: N802
        with self._func_lock:
            if self.niRFSG_GetDeembeddingSparameters_cfunc is None:
                ...
                self.niRFSG_GetDeembeddingSparameters_cfunc.argtypes = [ViSession, ctypes.POINTER(NIComplexNumber)]  # noqa: F405
                self.niRFSG_GetDeembeddingSparameters_cfunc.restype = None  # noqa: F405
        return self.niRFSG_GetDeembeddingSparameters_cfunc(vi, sparameters)
