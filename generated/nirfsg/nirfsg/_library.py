    ...
    def niRFSG_Create3dDeembeddingSparameterTableArray(self, vi, port, table_name, frequency, frequencies_size):  # noqa: N802
        with self._func_lock:
            if self.niRFSG_Create3dDeembeddingSparameterTableArray_cfunc is None:
                ...
                self.niRFSG_Create3dDeembeddingSparameterTableArray_cfunc.argtypes = [ViSession, ctypes.POINTER(ViChar), ctypes.POINTER(ViChar), ctypes.POINTER(NIComplexNumber), ViInt32]  # noqa: F405
    ...
    def niRFSG_GetDeembeddingSparameters(self, vi, sparameter_array_size, sparameters, number_of_sparameters, number_of_ports):  # noqa: N802
        with self._func_lock:
            if self.niRFSG_GetDeembeddingSparameters_cfunc is None:
                ...
                self.niRFSG_GetDeembeddingSparameters_cfunc.argtypes = [ViSession, ViInt32, ctypes.POINTER(NIComplexNumber), ctypes.POINTER(ViInt32), ctypes.POINTER(ViInt32)]  # noqa: F405
                self.niRFSG_GetDeembeddingSparameters_cfunc.restype = ViStatus  # noqa: F405
        return self.niRFSG_GetDeembeddingSparameters_cfunc(vi, sparameter_array_size, sparameters, number_of_sparameters, number_of_ports)
